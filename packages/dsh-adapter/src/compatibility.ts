...
import { LATEST_VERIFIED_DSH_VERSION, normalizeDshVersion, SUPPORTED_DSH_RANGE } from './contracts.js'
  ...
  const decorated: BackendCapabilities = {
    ...
    compatibilityWarning:
      normalizedVersion === undefined
        ...
        : `DSH ${normalizedVersion} is outside the tested compatibility range (${SUPPORTED_DSH_RANGE}); the newest verified adapter is ${LATEST_VERIFIED_DSH_VERSION}, and best-effort compatibility mode is active.`,
  }
  return {
    ...decorated,
