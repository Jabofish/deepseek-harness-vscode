...
3. 托管启动使用版本化参数数组：`0.0.1-rc.1/.2/.5`、`0.1.0-rc.2/.3`、`0.1.0-rc.6/.7` 为 `--profile web --host 127.0.0.1 --port <n>`；rc.8、`0.1.1-rc.1/.2`、`0.1.2-rc.1`、alpha.1–alpha.5、`0.1.3-alpha.1/.2` 和 `0.1.5-alpha.1` 在同一组参数中追加已由上游声明的 `--no-open`；未知版本不猜测该可选参数。
4. 扩展关闭后只结束本次扩展创建的进程。
