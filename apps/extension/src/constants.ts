import { DSH_PACKAGE_NAME, LATEST_SUPPORTED_DSH_VERSION } from '@dsh-vscode/dsh-adapter'
...
export const DSH_PACKAGE = `${DSH_PACKAGE_NAME}@${LATEST_SUPPORTED_DSH_VERSION}`
