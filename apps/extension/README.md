...
- Published DeepSeek Harness `0.1.0-rc.6` through `0.1.1-rc.2` Host/Web API, plus a prepared adapter for unpublished upstream `0.1.2-alpha.1`; unknown non-empty version labels are attempted in compatibility mode
