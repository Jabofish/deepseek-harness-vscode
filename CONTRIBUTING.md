...
当前承诺已发布的 DSH `0.1.0-rc.6` 至 `0.1.1-rc.2`；`0.1.2-alpha.1` 保留源码级预适配，
已发布的 `0.1.2-alpha.2`、`0.1.2-alpha.3`、`0.1.2-alpha.4` 和 `0.1.2-alpha.5` 提供独立适配，均不作为安装默认。连接到其他版本时必须先由最新已验证 Adapter 进行只读兼容探测；成功后显示警告并保留真实版本，候选失败时继续降级，禁止静默把未知版本当成精确支持。
